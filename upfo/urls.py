...
urlpatterns = patterns('',
    ...
    url(r'^betafi/logout/$', logout, name='logout'),
	...
	url(r'^betafi/make_upfo/$', make_upfo, name='make_upfo'),
	url(r'^betafi/del_upfo/$', del_upfo, name='del_upfo'),
	url(r'^betafi/facebook/$', facebook, name='facebook'),
	url(r'^betafi/feedback/$', feedback, name='feedback'),
	url(r'^betafi/settings/$', settingpage, name='settingpage'),
	url(r'^legal/$', legal, name='legal'),
	url(r'^about/$', about, name='about'),
	url(r'^channel/', 'django.views.generic.simple.direct_to_template', {'template': 'channel.html'}),
